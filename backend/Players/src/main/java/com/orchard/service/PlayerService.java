...
public class PlayerService {
	...
	public Player savePlayer(Player player) throws Exception {
		...
		if(!tempTeam.equals("NA")) {
		   ...
		   Double maximunBudget=restTemplate.getForObject("http://localhost:8000/teams/getBudget/"+tempTeam, Double.class);
		 ...
		 Double remainingBudget=maximunBudget-teamBudget;
		       ...
		       {
			    throw new Exception("player can't be added to team as it excceds team budgets ");
		       }
		}
